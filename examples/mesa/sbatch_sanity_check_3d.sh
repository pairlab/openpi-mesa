...
#SBATCH -J pi05_mesa_bimanual_lora_3d_sanity
#SBATCH -o examples/mesa/slurm_logs/sanity_3d_%j.out
#SBATCH -e examples/mesa/slurm_logs/sanity_3d_%j.err
#
# Pre-training sanity checks for pi05_mesa_bimanual_lora_3d: dataloader shape/
# dtype/numerics + one forward pass of Pi0Adapt3R on a real batch. Exits non-
# zero on any assertion failure. Meant to run before the 8h H100 training job.
...
uv run python examples/mesa/sanity_check_3d.py --config-name pi05_mesa_bimanual_lora_3d --batch-size 2
