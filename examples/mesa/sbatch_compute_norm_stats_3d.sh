...
#SBATCH -J pi05_mesa_bimanual_lora_3d_normstats
#SBATCH -o examples/mesa/slurm_logs/normstats_3d_%j.out
#SBATCH -e examples/mesa/slurm_logs/normstats_3d_%j.err
#
...
ls -la "$REPO_DIR/assets/pi05_mesa_bimanual_lora_3d/mesa_bimanual_2task_3d/" || true
